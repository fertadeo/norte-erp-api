...
-- Fecha: 2024
-- Descripción: Crea tablas para gestionar permisos granulares y asignación de permisos a roles
...
-- Tabla de asignación de permisos directos a usuarios (opcional, para casos especiales)
CREATE TABLE IF NOT EXISTS user_permissions (
    ...
    FOREIGN KEY (permission_id) REFERENCES permissions(id) ON DELETE CASCADE,
    FOREIGN KEY (granted_by) REFERENCES users(id) ON SET NULL,
